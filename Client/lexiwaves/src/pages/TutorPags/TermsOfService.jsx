...
const TermsOfService = () => {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <DotBackground>
        <div className="bg-neutral-00 rounded-lg shadow-lg p-6 mt-16 max-w-2xl mx-auto">

      

          <h1 className="text-2xl font-bold mt-6 text-white mb-4">Terms of Service</h1>
          ...
          <h2 className="text-xl font-semibold text-white mb-2">3. Content Policy</h2>
          <p className="text-white text-sm  mb-4">
          ...
          <div className="mb-4">
            <Link to="/tutor-details" className="text-blue-400 mt-2 text-sm underline">
              Go to Details Page
            </Link>
          </div>
        </div>
